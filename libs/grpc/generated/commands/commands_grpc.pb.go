...
func (c *commandsClient) ProcessCommand(ctx context.Context, in *ProcessCommandRequest, opts ...grpc.CallOption) (*ProcessCommandResponse, error) {
	out := new(ProcessCommandResponse)
	err := c.cc.Invoke(ctx, "/commands.Commands/ProcessCommand", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCommandsServer) ProcessCommand(context.Context, *ProcessCommandRequest) (*ProcessCommandResponse, error) {
...
func _Commands_ProcessCommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProcessCommandRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommandsServer).ProcessCommand(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/commands.Commands/ProcessCommand",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommandsServer).ProcessCommand(ctx, req.(*ProcessCommandRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Commands_ProcessCommand_Handler,
		},
	},
